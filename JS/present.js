...
const carHeader = document.getElementsByClassName("headline");

const screenWidth = window.innerWidth;

if (screenWidth <= 720) {
  // Set the width of the card element to 100% on screens with a width less than or equal to 720px.
  ...
  for (const carHeader of carHeaders) {
    carHeader.style.fontSize = "35vw !important";
  }
} else if (screenWidth > 720) {
  console.log(screenWidth);
  // Set the width to 720px for larger screens.
